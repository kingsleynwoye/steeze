  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Help choose your styles with our tools!"
        />
        <link rel="icon" href="/steeze.png" />
      </Head>
      <main>
        {showInitalSurvey && (
          <InitialSurvey
            surveyFinished={(data: any) => {
        ...
        {showFinalResults && <ClothingResults items={finalItems} />}
      </main>
    </>
  );
}
